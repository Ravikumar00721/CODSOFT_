...
@Composable
fun AddEDV(id:Long,viewModel: WishViewModel,navController: NavController)
{
    val `snack-message`=remember{
        mutableStateOf("")
    }
            ...
            Button(onClick = {
                if (viewModel.wishTitleState.isNotEmpty() && viewModel.wishDescriptionState.isNotEmpty()) {
                    ...
                    else
                    {
                        ...
                        `snack-message`.value="Wish Has Been Created"
                    }
                } else {
                    `snack-message`.value="Enter fields to create a wish"
                }
                scope.launch {
